      ...
      <div class="col-lg-8">
        ...
        <hr>
            ...
            <div class="form-group">
              ...
              <input type="text" name="location" class="form-control" id="contact-name" placeholder="" data-rule="minlen:4" data-msg="Please enter at least 4 chars" >
              <div class="validate"></div>
            </div>            

            <div class="form-group">
             <label>Penganjur Kursus</label>
              <input type="text" name="organizer" class="form-control" id="contact-name" placeholder="" data-rule="minlen:4" data-msg="Please enter at least 4 chars" >
              <div class="validate"></div>
            </div>  
        <hr>            
        ...
        <div class="form-group">
              ...
              <input type="name" name="note_name" class="form-control" id="note-name" placeholder="" data-rule="minlen:4" data-msg="Please enter at least 4 chars" >
              <div class="validate"></div>
        ...
        <div class="form-group">
              ...
              <div class="surat-akuan col-sm-12 col-md-6" style="align:center; padding-top: 12px">
                    ...
                    <div class="col-sm-9" style="padding-left: 0px;padding-top: 9px">
                            <input name="gallery_upload" type="file" class="custom-file-inputform-control form-control-alternative" placeholder="" value="" required="" autofocus="">
                            <span style="margin-left: 15px; width: 480px;" class="custom-file-control"></span>
                    </div>
             </div>               
